...
# AL2023 can ship with curl-minimal; installing curl may conflict unless we allow replacement
...
def get_conn():
    ...
    db = c.get("dbname") or c.get("database") or c.get("db") or "labdb"
...
def home():
    ...
    <p>GET /init</p>
    <p>POST or GET /add?note=hello</p>
    <p>GET /list</p>
    """
